 ...
 * @date 19July2009
 */
class Cbisnett_AttributeExchange extends Zend_OpenId_Extension
{
	/**
    ...
    public function prepareRequest(&$params)
    {
    	...
    	// Set the name space
    	$params['openid.ns.ax'] = self::NS_URL;
    ...
    public function parseResponse($params)
    {
    	...
    	if (isset($params['openid']['ns']['ax']) && $params['openid']['ns']['ax'] == self::NS_URL)
    		$ax = $params['openid']['ax'];
    	else
    	{
